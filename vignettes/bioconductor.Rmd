...
Welcome to the `bigPint` package! If you are a new user, please visit the package website at [https://lrutter.github.io/bigPint/](https://lrutter.github.io/bigPint/). There, you will find a general overview of the `bigPint` package and the motivations behind it. You will also find ten short vignette articles that we recommend reading in order. These short vignette articles consist of reproducible code that provide:
