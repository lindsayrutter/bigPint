...
library("htmltools")
library("vembedr")
embed_vimeo("349395290", width = 700, height = 500) %>% div(class = "vembedr") %>%
  div(align = "left")
```
...
library("htmltools")
library("vembedr")
embed_vimeo("349396087", width = 700, height = 500) %>% div(class = "vembedr") %>%
  div(align = "left")
```
...
library("htmltools")
library("vembedr")
embed_vimeo("349398286", width = 700, height = 500) %>% div(class = "vembedr") %>%
  div(align = "left")
```
