...
<iframe width="690" height="600" src="https://www.youtube.com/watch?v=w3jLJU7DT5E" style="border: 3px black solid;" allowfullscreen></iframe>

<video controls="controls" width="690" height="600" name="Video Name" src="https://www.youtube.com/watch?v=w3jLJU7DT5E"></video>

<object CLASSID="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" width="320" height="256" CODEBASE="http://www.apple.com/qtactivex/qtplugin.cab">
    <param name="src" value="sample.mov">
    <param name="qtsrc" value="https://www.youtube.com/watch?v=w3jLJU7DT5E">
    <param name="autoplay" value="true">
    <param name="loop" value="false">
    <param name="controller" value="true">
    <embed src="sample.mov" qtsrc="https://www.youtube.com/watch?v=w3jLJU7DT5E" width="320" height="256" autoplay="true" loop="false" controller="true" pluginspage="http://www.apple.com/quicktime/"></embed>
</object>
____________________________________________________________________________________
