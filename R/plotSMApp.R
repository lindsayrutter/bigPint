...
#' @importFrom ggplot2 ggplot aes_string aes xlim ylim geom_boxplot theme geom_hex
#' geom_abline coord_cartesian
...
#' tabItems box tabItem dashboardPage dashboardHeader
#' @importForm GGally ggpairs
#' @return A Shiny application that shows a scatterplot matrix with hexagon bins 
#' and allows users to click on hexagon bins to determine how many genes they each
#' contain. The user can download a file that contains the gene IDs that are 
#' located in the clicked hexagon bin.
#' @export
#' @examples
#' \dontrun{
#' # Example: Create interactive scatterplot matrix for first two treatment groups
#' # of data.
#' 
#' data(soybean_cn_sub)
