...
#' @format A nested list of length 1. The list contains the metrics for the 5,604 genes for the one treatment group combination.
#' @seealso \code{\link{soybean_ir_sub}} for information about the treatment groups
#' @references
