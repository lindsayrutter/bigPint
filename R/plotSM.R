...
#' 
#' \dontrun{
#' # Example 1: Plot scatterplot matrix of points. Saves three plots to outDir because saveFile equals TRUE by default.
#' plotSM(soybean_cn_sub, soybean_cn_sub_metrics)
#' }
#' 
#' # Example 2: Plot scatterplot matrix of points. Return list of plots so user can tailor them (such as add title) and does not save to outDir because saveFile equals FALSE.
...
#' ret <- plotSM(soybean_cn_sub_st, soybean_cn_sub_metrics, pointColor = "#00C379", saveFile = FALSE)
#' ret[[1]] + xlab("Standardized read counts") + ylab("Standardized read counts")
#' 
#' # Example 4: Plot scatterplot matrix of hexagons.
#' ret <- plotSM(soybean_cn_sub, soybean_cn_sub_metrics, option = "hexagon", xbins = 5, pointSize = 0.1, saveFile = FALSE)
#' ret[[2]]
#' 
...
#' ret <- plotSM(soybean_ir_sub, option = "orthogonal", threshOrth = 2.5, pointSize = 0.2, saveFile = FALSE)
#' ret[[1]]
#' ret <- plotSM(soybean_ir_sub, soybean_ir_sub_metrics, option = "orthogonal", threshOrth = 2.5, pointSize = 0.2, saveFile = FALSE)
#' ret[[1]]
#'
#' # Example 6: Plot scatterplot matrix of fold change.
#' ret <- plotSM(soybean_cn_sub, soybean_cn_sub_metrics, option = "foldChange", threshFC = 0.5, pointSize = 0.2, saveFile = FALSE)
#' ret[[1]]
