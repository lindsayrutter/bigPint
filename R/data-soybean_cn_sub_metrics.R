...
#' genes and all pairwise combinations of treatment groups. To save on size, 
#' this example dataset was generated by obtaining a random subset of 1 out 
#' of 10 genes from the original resource.
#' @docType data
#' @format a \code{RData} instance, List with one list element per treatment
#' group combination and 1 row per gene 
#' @details \itemize{
    #' \item ID gene name
...
#' @seealso \code{\link{soybean_cn_sub}} for information about the treatment 
#' groups
NULL
